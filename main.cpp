...
public:
    ...
    void run()
    {
        ...
        m_skySystem.Init(m_renderPass, m_swapChainExtent, m_pipelineLayout);
        m_world.Init();
...
#pragma endregion
    ...
    void initVulkan()
    {
        ...
        createFramebuffers();
        createCommandPool();
        TF::TFVkGfxDevice::Get().physicsDevice = m_physicalDevice;
        TF::TFVkGfxDevice::Get().cmdPool = m_commandPool;
        TF::TFVkGfxDevice::Get().logicalDevice = m_device;
        TF::TFVkGfxDevice::Get().graphicsQueue = m_graphicsQueue;
        //createTextureImage();
        ...
        m_gltfModel = new GltfModel(Vfs::ConcatPath(Vfs::GetResPath(), "/model/FlightHelmet/FlightHelmet.gltf").generic_string(),5.0f);
