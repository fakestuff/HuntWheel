...
public:
    ...
    void run()
    {
        ...
        m_skySystem.Init(TF::s_tfVulkanDevice, m_renderPass, m_swapChainExtent, m_pipelineLayout);
        m_world.Init();
...
#pragma endregion
    ...
    void initVulkan()
    {
        ...
        createFramebuffers();
        createCommandPool();
        TF::s_tfVulkanDevice.physicsDevice = m_physicalDevice;
        TF::s_tfVulkanDevice.cmdPool = m_commandPool;
        TF::s_tfVulkanDevice.logicalDevice = m_device;
        TF::s_tfVulkanDevice.graphicsQueue = m_graphicsQueue;
        //createTextureImage();
        ...
        m_gltfModel = new GltfModel(TF::s_tfVulkanDevice, Vfs::ConcatPath(Vfs::GetResPath(), "/model/FlightHelmet/FlightHelmet.gltf").generic_string(),5.0f);
