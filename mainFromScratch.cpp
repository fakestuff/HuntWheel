...
void generateMipmaps(VkImage image, VkFormat imageFormat, int32_t texWidth, int32_t texHeight, uint32_t mipLevels) {
    ...
    for (uint32_t i = 1; i < mipLevels; i++) //start from 1, since mip0 should already be blit
    {
...
void createImage(uint32_t width, uint32_t height, uint32_t mipLevels, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory) 
    ...
    void createTextureImage ()
    {
        ...
        createImage(texSharedPtr->Width, texSharedPtr->Height, m_mipLevels, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_TRANSFER_SRC_BIT | VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, m_textureImage, m_textureImageMemory);
        ...
        copyBufferToImage(m_stagingBuffer, m_textureImage, static_cast<uint32_t>(texSharedPtr->Width), static_cast<uint32_t>(texSharedPtr->Height));
        ...
        generateMipmaps(m_textureImage, VK_FORMAT_R8G8B8A8_SRGB, texSharedPtr->Width, texSharedPtr->Height, m_mipLevels);
